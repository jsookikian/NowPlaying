...
#            applied to a given source file. 
#
#            Possible tags must be defined in a the "TAGS" variable
#              TAGS=neon sse2
#
#            Tag specific CFLAGS are defined like this...
#              CFLAGS.neon = "-fpu=neon"
#              CFLAGS.sse2 = "-fpu=sse2"
# -----------------------------------------------------------------------------
get-src-file-tag-cflags = $(foreach __tag,$(TAGS),$(CFLAGS.$(patsubst .%.,%,$(findstring .$(__tag).,$(1)))))
