...
CDEFS_COMMON = -DWIN32 -DUNICODE -D_UNICODE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_WIN32_WINNT=0x0600

# -- Experiment with -Z7 instead of -Zi, to avoid MSPDB*.DLL problems.
...
CFLAGS_DEBUG=-Od -MTd -J -W4 -GS -GF -Gm- -RTC1 -nologo -Z7 -EHsc -Fd$(PDB_NAME) -D_DEBUG $(CDEFS_COMMON)
CFLAGS_RELEASE=-O2 -MT -J -W4 -GS -GF -Gm- -Z7 -EHsc -Fd$(PDB_NAME) -DNDEBUG $(CDEFS_COMMON)
...
LDLIBS_PLATFORM=ws2_32.lib advapi32.lib iphlpapi.lib
...
ifeq ($(ARCH),)
	...
	ifneq ($(findstring Version 19,$(ccver)),)
		COMPILER_VER=vs15
	else ifneq ($(findstring Version 18,$(ccver)),)
		COMPILER_VER=vs13
...
ifeq ($(IMPLARCH),x86-32)
	ifeq ($(findstring bass,$(extra_libs)),)
