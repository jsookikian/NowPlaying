...
CFLAGS_DEBUG=-g $(ARCHFLAGS) -fPIC -funsigned-char -fvisibility=hidden -Wall -pedantic -Wextra -Wno-long-long -Wno-variadic-macros -Wno-missing-field-initializers -Wpointer-arith -D_DEBUG 
CFLAGS_RELEASE=-Os $(ARCHFLAGS) -fPIC -funsigned-char -fvisibility=hidden -Wall -pedantic -Wextra -Wno-long-long -Wno-variadic-macros -Wno-missing-field-initializers -Wpointer-arith -DNDEBUG
