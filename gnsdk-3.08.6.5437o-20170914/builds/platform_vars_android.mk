...
ifeq ($(NDK_API_LEVEL),)
	...
	ARCHFLAGS = -mfpu=vfp -mfloat-abi=softfp -ffunction-sections -funwind-tables -fstack-protector -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -Wa,--noexecstack -Wno-psabi -fpic
...
ifeq ($(NDK_API_LEVEL),)
	...
	ARCHFLAGS =  -mfpu=vfpv3-d16 -mfloat-abi=softfp -ffunction-sections -funwind-tables -fstack-protector -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -Wa,--noexecstack -Wno-psabi -fpic -march=armv7-a

# else ifeq ($(ARCH),android_armeabi-v7a-hard)
# 	IMPLARCH = armeabi-v7a-hard
# 	SYSROOT_ARCH = arm
# 	TOOLNAME = arm-linux-androideabi-4.9
# 	TOOLPREFIX = arm-linux-androideabi
# ifeq ($(NDK_API_LEVEL),)
# 	NDK_API_LEVEL=9
# endif
# 	ARCHFLAGS =  -mfpu=vfpv3-d16 -mfloat-abi=hard -ffunction-sections -funwind-tables -fstack-protector -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -Wa,--noexecstack -Wno-psabi -fpic -march=armv7-a -mthumb

else ifeq ($(ARCH),android_arm64-v8a)
	IMPLARCH = arm64-v8a
	SYSROOT_ARCH = arm64
	TOOLNAME = aarch64-linux-android-4.9
	TOOLPREFIX = aarch64-linux-android
ifeq ($(NDK_API_LEVEL),)
	NDK_API_LEVEL=21
endif
	ARCHFLAGS =  -ffunction-sections -funwind-tables -fstack-protector -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -Wa,--noexecstack -Wno-psabi -fpic
...
ifeq ($(NDK_API_LEVEL),)
	...
	ARCHFLAGS = -ffunction-sections -funwind-tables -fstack-protector -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -Wa,--noexecstack -Wno-psabi -fpic -funsigned-char

else ifeq ($(ARCH),android_mips64)
	IMPLARCH = mips64
	SYSROOT_ARCH = mips64
	TOOLNAME = mips64el-linux-android-4.9
	TOOLPREFIX = mips64el-linux-android
ifeq ($(NDK_API_LEVEL),)
	NDK_API_LEVEL=21
endif
	ARCHFLAGS = -ffunction-sections -funwind-tables -fstack-protector -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -Wa,--noexecstack -Wno-psabi -fpic -funsigned-char 	
...
ifeq ($(NDK_API_LEVEL),)
	...
	ARCHFLAGS = -ffunction-sections -funwind-tables -fstack-protector -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -Wa,--noexecstack -Wno-psabi -Wall -fpic -pipe -DANDROID -DNDEBUG -mtune=atom -march=atom -msse3 -mssse3 -funsigned-char
	LD_ARCHFLAGS += -lm -lz -Wl,--no-undefined -Wl,-z,noexecstack -mtune=atom -march=atom -no-canonical-prefixes -landroid

else
$(error ARCH="$(ARCH)" is unsupported. Try android_armeabi, android_armeabi-v7a, android_arm64-v8a, android_mips, android_mips64, android_x86 or android_x86_64)
endif


SYSROOT:=$(NDK_ROOT)/platforms/android-$(NDK_API_LEVEL)/arch-$(SYSROOT_ARCH)
ifneq ($(findstring CYGWIN, $(UNAME)),)
...
LDLIBS_PLATFORM = -Wl,-soname,$(SHARED_LIB_TARGET)
