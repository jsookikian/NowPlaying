    ...
    class Playlist
    {
        ...
        ***************************************************************************/
        ...
        DoPlaylistMorelikethis(GnUser user, GnPlaylistCollection playlistCollection)
        {
            ...
            GnPlaylistResults playlistResult = playlistCollection.GenerateMoreLikeThis(user, data);
         ...
         ***************************************************************************/
        private static void
        EnumeratePlaylistResults(GnUser user, GnPlaylistCollection playlistCollection, GnPlaylistResults playlistResult)
        {
        ...
        DoPlaylistPdl(GnUser user, GnPlaylistCollection playlistCollection)
        {
            ...
            for (stmtIdx = 0; stmtIdx < pdlstmtCount; stmtIdx++)
            {
                ...
                if (error.ErrorCode() == 0)
                {
                    ...
                    */
                    GnPlaylistResults playlistResult = playlistCollection.GeneratePlaylist(user, pdlStatements[stmtIdx], gdoSeed);
