...
*/
public class GnDataObject : GnGdoObject {
  private global::System.Runtime.InteropServices.HandleRef swigCPtr;

  internal GnDataObject(global::System.IntPtr cPtr, bool cMemoryOwn) : base(gnsdk_csharp_marshalPINVOKE.GnDataObject_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);
  }

  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(GnDataObject obj) {
  ...
  public GnDataObject(string id, string idTag, GnIDSource idSrcEnum) : this(gnsdk_csharp_marshalPINVOKE.new_GnDataObject__SWIG_2(id, idTag, (int)idSrcEnum), true) {
    if (gnsdk_csharp_marshalPINVOKE.SWIGPendingException.Pending) throw gnsdk_csharp_marshalPINVOKE.SWIGPendingException.Retrieve();
  }
...
*/
  public string IDSource(GnIDSource IDSourceEnum) {
    string ret = gnsdk_csharp_marshalPINVOKE.GnDataObject_IDSource(swigCPtr, (int)IDSourceEnum);
    return ret;
  }
...
*/
  ...
  public int IntValue(string valueKey, uint ordinal) {
    int ret = gnsdk_csharp_marshalPINVOKE.GnDataObject_IntValue__SWIG_0(swigCPtr, valueKey, ordinal);
    return ret;
  }

  public int IntValue(string valueKey) {
    int ret = gnsdk_csharp_marshalPINVOKE.GnDataObject_IntValue__SWIG_1(swigCPtr, valueKey);
    return ret;
  }
