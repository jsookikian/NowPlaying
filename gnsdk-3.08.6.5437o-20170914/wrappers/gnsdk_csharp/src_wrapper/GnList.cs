...
* Gracenote list.
*/
public class GnList : GnListObject {
  private global::System.Runtime.InteropServices.HandleRef swigCPtr;

  internal GnList(global::System.IntPtr cPtr, bool cMemoryOwn) : base(gnsdk_csharp_marshalPINVOKE.GnList_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);
  }

  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(GnList obj) {
...
*/
  ...
  static private global::System.IntPtr SwigConstructGnList(string serializedList) {
...
*/
  public GnString Render(uint levels, GnListRenderFormat renderFormat, bool bIndented) {
    GnString ret = new GnString(gnsdk_csharp_marshalPINVOKE.GnList_Render__SWIG_0(swigCPtr, levels, (int)renderFormat, bIndented), true);
    if (gnsdk_csharp_marshalPINVOKE.SWIGPendingException.Pending) throw gnsdk_csharp_marshalPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public GnString Render(uint levels, GnListRenderFormat renderFormat) {
    GnString ret = new GnString(gnsdk_csharp_marshalPINVOKE.GnList_Render__SWIG_1(swigCPtr, levels, (int)renderFormat), true);
    if (gnsdk_csharp_marshalPINVOKE.SWIGPendingException.Pending) throw gnsdk_csharp_marshalPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
...
*  @param renderFlags		Flags configuring rendering output
*/
  public GnString RenderLevel(uint level, GnListRenderFormat renderFormat, bool bIndented) {
    GnString ret = new GnString(gnsdk_csharp_marshalPINVOKE.GnList_RenderLevel__SWIG_0(swigCPtr, level, (int)renderFormat, bIndented), true);
    if (gnsdk_csharp_marshalPINVOKE.SWIGPendingException.Pending) throw gnsdk_csharp_marshalPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public GnString RenderLevel(uint level, GnListRenderFormat renderFormat) {
    GnString ret = new GnString(gnsdk_csharp_marshalPINVOKE.GnList_RenderLevel__SWIG_1(swigCPtr, level, (int)renderFormat), true);
    if (gnsdk_csharp_marshalPINVOKE.SWIGPendingException.Pending) throw gnsdk_csharp_marshalPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
