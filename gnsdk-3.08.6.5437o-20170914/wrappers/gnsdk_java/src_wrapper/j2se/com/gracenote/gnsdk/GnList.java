...
*/ 
  ...
  public GnString render(long levels, GnListRenderFormat renderFormat, boolean bIndented) throws com.gracenote.gnsdk.GnException {
    return new GnString(gnsdk_javaJNI.GnList_render__SWIG_0(swigCPtr, this, levels, renderFormat.swigValue(), bIndented), true);
  }

  public GnString render(long levels, GnListRenderFormat renderFormat) throws com.gracenote.gnsdk.GnException {
    return new GnString(gnsdk_javaJNI.GnList_render__SWIG_1(swigCPtr, this, levels, renderFormat.swigValue()), true);
  }
...
*/ 
  ...
  public GnString renderLevel(long level, GnListRenderFormat renderFormat, boolean bIndented) throws com.gracenote.gnsdk.GnException {
    return new GnString(gnsdk_javaJNI.GnList_renderLevel__SWIG_0(swigCPtr, this, level, renderFormat.swigValue(), bIndented), true);
  }

  public GnString renderLevel(long level, GnListRenderFormat renderFormat) throws com.gracenote.gnsdk.GnException {
    return new GnString(gnsdk_javaJNI.GnList_renderLevel__SWIG_1(swigCPtr, this, level, renderFormat.swigValue()), true);
  }
