...
*/ 
  ...
  public GnMusicIdFileInfo(GnMusicIdFileInfo rhs) throws com.gracenote.gnsdk.GnException {
    this(gnsdk_javaJNI.new_GnMusicIdFileInfo(GnMusicIdFileInfo.getCPtr(rhs), rhs), true);
  }
