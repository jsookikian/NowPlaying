...
* You can all this API any time after a {@link GnManager} instance is constructed successfully. The returned 
...
* You can call this API at any time after a {@link GnManager} instance is constructed successfully. The returned 
* string is a constant. Do not attempt to modify or delete. 
* Example: 1.2.3.123 (Major.Minor.Improvement.Build) 
* Major: New functionality 
* Minor: New or changed features 
...
*/ 
  ...
  public static void initialize() throws com.gracenote.gnsdk.GnException {
    gnsdk_javaJNI.GnManager_initialize();
  }

  public static void shutdown() throws com.gracenote.gnsdk.GnException {
    gnsdk_javaJNI.GnManager_shutdown();
  }

  public static void applyLicense(String license, GnLicenseInputMode licenseInputMode) throws com.gracenote.gnsdk.GnException {
    gnsdk_javaJNI.GnManager_applyLicense(license, licenseInputMode.swigValue());
  }
...
*/ 
  ...
  public GnStoreOps tempCacheStore() {
    return new GnStoreOps(gnsdk_javaJNI.GnManager_tempCacheStore(swigCPtr, this), false);
  }
