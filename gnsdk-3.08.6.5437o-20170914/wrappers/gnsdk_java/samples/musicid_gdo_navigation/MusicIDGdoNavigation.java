...
public class MusicIDGdoNavigation {
    ...
    navigateTrack(GnTrack track, int tabIndex) throws GnException {
        ...
        GnAudioWorkIterator iterAW = track.audioWorks().getIterator();
        while (iterAW.hasNext()) {
            navigateAudioWork(iterAW.next(), tabIndex);
        }
    }
    ...
    //
    void
    navigateAudioWork(GnAudioWork audioWork, int tabIndex) throws GnException {
        String tabString = createTabString(tabIndex);

        tabIndex++;

        System.out.printf("%sAudio Work:\n", tabString);

        displayValue("TUI", audioWork.tui(), tabIndex);

        navigateTitleOfficial(audioWork.title(), tabIndex);

        displayValue("Composition Form", audioWork.compositionForm(), tabIndex);
    ...
    initializeLocalDatabase() throws GnException {
        ...
        config.set(GnConfigOptionEnable.kConfigOptionEnableLookupDatabaseMusicID, true);
