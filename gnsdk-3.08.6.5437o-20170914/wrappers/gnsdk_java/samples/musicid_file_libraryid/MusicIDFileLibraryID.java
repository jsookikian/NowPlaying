...
public class MusicIDFileLibraryID {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if ( new File(GRACENOTE_PRODUCTION_DATABASE_LOCATION).exists() == false ) {
            System.out.println("Data directory does not exist. " + GRACENOTE_PRODUCTION_DATABASE_LOCATION);
            System.exit(-1);
            return;
        }
    ...
    // doSample
    //
    void doSample( String clientId, String clientIdTag, String licensePath, String libPath, GnLookupMode lookupMode ) throws GnException{
    ...
    doMusicidFile( GnUser gnUser ) throws GnException {
        ...
        for ( int i = 0 ; i < sampleAudioFiles.length ; i++ )
        {
            ...
            setQueryData( midf, fileIdent, GRACENOTE_PRODUCTION_DATABASE_LOCATION + sampleAudioFiles[i] );
        }
