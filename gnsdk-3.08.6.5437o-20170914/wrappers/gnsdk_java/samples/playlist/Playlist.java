...
public class Playlist {
    ...
    doSample( String clientId, String clientIdTag, String licensePath, String libPath, GnLookupMode lookupMode ) throws GnException{
        ...
        // Initialize SQLite module to use as our database - required for GnPlaylistStorage, local or online
    ...
    doPDLGeneration( GnUser gnUser, GnPlaylistCollection collection ) throws GnException{
        ...
        for ( String statement : pdlStatements ){
            ...
            GnPlaylistResults result = collection.generatePlaylist( gnUser, statement, getSeedData(gnUser, collection) );
    ...
    doPlaylistMoreLikeThis( GnUser gnUser, GnPlaylistCollection collection ) throws GnException{
        ...
        GnPlaylistResults resultMoreLikeThis = collection.generateMoreLikeThis( gnUser, getSeedData( gnUser, topColl ) );
        ...
        /*Generating more like this Playlist*/
        GnPlaylistResults resultCustomMoreLikeThis = collection.generateMoreLikeThis( gnUser, getSeedData( gnUser, collection ) );
    ...
    initializeLocalDatabase() throws GnException
    {
        ...
        config.set(GnConfigOptionEnable.kConfigOptionEnableLookupDatabaseMusicIDCD, true);

        GnLookupDatabase lookupDB = new GnLookupDatabase(GRACENOTE_PRODUCTION_DATABASE, config);
        // To see detailed information about the lookup database, enable this:
        /*    GnDataObject dbInfo = lookupDB.info();
    ...
    //
    void
    displayPlaylistResults( GnUser gnUser, GnPlaylistCollection collection, GnPlaylistResults result ) throws GnException{
