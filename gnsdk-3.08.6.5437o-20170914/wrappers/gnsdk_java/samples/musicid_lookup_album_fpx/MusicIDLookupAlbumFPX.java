...
public class MusicIDLookupAlbumFPX {
    ...
    public static void main(String[] args) {
        ...
        int retVal = new MusicIDLookupAlbumFPX().doSample(
                            "1078812063",     // Client ID
                            "39627BF3E8DB84AAC9326192BBAB0CCA",     // Client ID Tag
                            "licfile.txt",     // License
                            "../../../../lib/mac_x86-64/",     // GNSDK Library Path
    ...
    // doSample
    //
    int doSample( String clientId, String clientIdTag, String licensePath, String libPath, GnLookupMode lookupMode ){
        ...
        try{
            ...
            retVal = performAlbumFPXLookup( gnUser );
    ...
    performAlbumFPXLookup( GnUser gnUser ) throws GnException
    {
        ...
        try {
            ...
            audioFileInputStream = new FileInputStream("./RECORDING.wav");
            ...
            mid.fingerprintBegin(GnFingerprintType.kFingerprintTypeGNFPX, 44100, 16, 1);
    ...
    initializeLocalDatabase() throws GnException
    {
        ...
        gnStorage.storageLocation( "../../../../sample_data/gdb" );
...
//
    ...
    displayAlbum( GnAlbum album ) throws GnException{
        ...
        try {
            PrintWriter writer = new PrintWriter("metadata.txt");
            writer.println(album.title().display() + "," + album.trackMatched().title().display() + "," + album.artist().name().display());
            writer.close();
        }
        catch (Exception e) {
             ;
