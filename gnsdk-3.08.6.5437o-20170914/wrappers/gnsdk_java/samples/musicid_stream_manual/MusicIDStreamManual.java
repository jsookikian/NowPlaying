 ...
 */
/*
 * Name: musicid_stream_manual.MusicIDStreamManual
 * Description:
 *
...
public class MusicIDStreamManual {
    ...
    public static void main(String[] args) {
        ...
        try {
            new MusicIDStreamManual().doSample(
    ...
    doSample( String clientId, String clientIdTag, String licensePath, String libPath, GnLookupMode lookupMode ) throws GnException{
        ...
        doMusicidStreamManual(gnUser);
    }
    
    //=============================================================================================
    // doMusicidStreamManual
    //
    void
    doMusicidStreamManual( GnUser gnUser ) throws GnException {
    ...
    initializeLocalDatabase() throws GnException {
        ...
        // Initialize Local Stream module to enable local queries
        GnLookupLocalStream gnLookupLocalStream = GnLookupLocalStream.enable();
        gnLookupLocalStream.storageLocation( "../../../../sample_data/gdb" );
