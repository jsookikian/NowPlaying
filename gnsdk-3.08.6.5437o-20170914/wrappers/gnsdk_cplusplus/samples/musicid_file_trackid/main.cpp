...
/*
 * Name: MusicID-File TrackID sample application
 * Description:
...
main(int argc, char* argv[])
{
	...
	try
	{
		...
		std::cout << "\n-------TrackID with 'RETURN_SINGLE' option:-------"<< std::endl;
		do_musicid_file(user, kQueryReturnSingle, kResponseAlbums);

		std::cout << "\n-------TrackID with 'RETURN_ALL' option:-------"<< std::endl;
