...
namespace gracenote
{
	...
	*/
	 ...
	 */
	class GnListElement : public GnObject<gnsdk_list_element_handle_t>
	{
	public:
		GNWRAPPER_ANNOTATE
		 ...
		 */
		explicit
		GnListElement(gnsdk_list_element_handle_t handle) : GnObject<gnsdk_list_element_handle_t>(handle) { }
		...
		*/
		...
		{
			return list_element_child_iterable(list_element_child_provider(native()),GN_BASE_START);
		}
	...
	*/
	 ...
	 * Gracenote list.
	 */
	class GnList : public GnObject<gnsdk_list_handle_t>
	{
	public:
		GNWRAPPER_ANNOTATE
		...
		* constructor 
		*/		
		GnList(gnsdk_list_handle_t listHandle) : GnObject<gnsdk_list_handle_t>(listHandle) { }
		 ...
		 */
		GnString
		Render(gnsdk_uint32_t levels, GnListRenderFormat renderFormat, bool bIndented=true) throw (GnError);
		 ...
		 */
		GnString
		RenderLevel(gnsdk_uint32_t level, GnListRenderFormat renderFormat, bool bIndented=true) throw (GnError);
		...
		{
			return list_element_iterable(list_element_provider(native(), level),GN_BASE_START);
		}
