	...
	namespace moodgrid
	{
		...
		*/
		struct GnMoodgridDataPoint
		{
			 ...
			 */
			bool
			operator == (const GnMoodgridDataPoint& rhs) const { return ( X == rhs.X ) && ( Y == rhs.Y ); }
			gnsdk_uint32_t X;
			gnsdk_uint32_t Y;
		...
		*/
		...
		public:
			 ...
			 */
			bool
			operator == (const GnMoodgridIdentifier& rhs) const { return ( (ident_ == rhs.ident_) && (group_ == rhs.group_)); }
		...
		*/
		class GnMoodgridResult : public GnObject<gnsdk_moodgrid_result_handle_t>
		{
		public:
			GNWRAPPER_ANNOTATE
			 ...
			 */
			explicit
			GnMoodgridResult(gnsdk_moodgrid_result_handle_t handle) : GnObject<gnsdk_moodgrid_result_handle_t>(handle) { }
			 ...
			 * @return identifiers
			 */
			moodidentifier_iterable
			Identifiers() const
			{
				return moodidentifier_iterable(moodgrid_result_provider(native()), GN_BASE_START);
			}
		...
		*/
		class GnMoodgridProvider : public GnObject<gnsdk_moodgrid_provider_handle_t>
		{
		public:
			GNWRAPPER_ANNOTATE
			/**
			 ...
			 */
			explicit
			GnMoodgridProvider(gnsdk_moodgrid_provider_handle_t handle) : GnObject<gnsdk_moodgrid_provider_handle_t>(handle) { }
		...
		*/
		class GnMoodgridPresentation : public GnObject<gnsdk_moodgrid_presentation_handle_t>
		{
		public:
			GNWRAPPER_ANNOTATE
			 ...
			 */
			GnMoodgridPresentation() : coordinate_(kMoodgridCoordinateTopLeft)  { }

			/**
			 * Constructor for GnMoodgridPresentation for native C handles.
			 */
			GnMoodgridPresentation(gnsdk_moodgrid_presentation_handle_t handle, GnMoodgridCoordinateType coordinate) : GnObject<gnsdk_moodgrid_presentation_handle_t>(handle), coordinate_(coordinate) { }
