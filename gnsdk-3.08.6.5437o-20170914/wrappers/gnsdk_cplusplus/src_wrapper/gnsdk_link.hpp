...
namespace gracenote
{
	namespace link
	{
		 ...
		 * GnLink
		 */
		class GnLink : public GnObject<gnsdk_link_query_handle_t>
		{
		public:
			GNWRAPPER_ANNOTATE

			GnLink(const metadata::GnDataObject& gnDataObject, const GnUser& user, IGnStatusEvents* pEventHandler = GNSDK_NULL) throw (GnError);
			GnLink(const metadata::GnDataObject& gnDataObject, const GnUser& user, GnManagedPtr<IGnStatusEvents*> eventHandler) throw (GnError);

			GnLink(const GnListElement& listElement, const GnUser& user, IGnStatusEvents* pEventHandler = GNSDK_NULL) throw (GnError);
			GnLink(const GnListElement& listElement, const GnUser& user, GnManagedPtr<IGnStatusEvents*> eventHandler) throw (GnError);
			 ...
			 */
			GnLinkContent
			CoverArt(GnImageSize imageSize, GnImagePreferenceType imagePreference, gnsdk_uint32_t item_ord = 1) throw (GnError);
			 ...
			 */
			GnLinkContent
			GenreArt(GnImageSize imageSize, GnImagePreferenceType imagePreference, gnsdk_uint32_t item_ord = 1) throw (GnError);
			 ...
			 */
			GnLinkContent
			Image(GnImageSize imageSize, GnImagePreferenceType imagePreference, gnsdk_uint32_t item_ord = 1) throw (GnError);
			 ...
			 */
			GnLinkContent
			ArtistImage(GnImageSize imageSize, GnImagePreferenceType imagePreference, gnsdk_uint32_t item_ord = 1) throw (GnError);
		...
		private:
			void
			createWithObject(const metadata::GnDataObject& gnDataObject, const GnUser& user) throw (GnError);
			void
			createWithElem(const GnListElement& listElement, const GnUser& user) throw (GnError);
		 ...
		 * GnLinkContent
		 */
		class GnLinkContent : public GnObject<const gnsdk_byte_t*>
		{
		public:
			GNWRAPPER_ANNOTATE
