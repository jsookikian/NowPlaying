...
static GnLinkContent _GnImageArt(gnsdk_link_query_handle_t handle, GnImageSize imageSize, GnImagePreferenceType imagePreference, GnLinkContentType linkContentType, gnsdk_uint32_t item_ord) throw (GnError);
...
GnLinkOptions::LookupMode(gracenote::GnLookupMode lookupMode) throw (GnError)
{
	...
	error = gnsdk_link_query_option_set(weakhandle_, GNSDK_LINK_OPTION_LOOKUP_MODE, gnconvert::gn_lookup_mode_to_string(lookupMode));
 ...
 */
void
GnLinkOptions::NetworkInterface(gnsdk_cstr_t intfName) throw (GnError)
{
	gnsdk_error_t error;
	
	error = gnsdk_link_query_option_set(weakhandle_, GNSDK_QUERY_OPTION_NETWORK_INTERFACE, intfName);
	if (error) { throw GnError(); }
}

gnsdk_cstr_t
GnLinkOptions::NetworkInterface() throw (GnError)
{
	gnsdk_cstr_t intfName = gnstd::kEmptyString;
	gnsdk_error_t error;
	
	error = gnsdk_link_query_option_get(weakhandle_, GNSDK_QUERY_OPTION_NETWORK_INTERFACE, &intfName);
	if (error) { throw GnError(); }
	...
	cancelled_(false)
{
	...
	createWithObject(gnDataObject, user);
}

GnLink::GnLink(const metadata::GnDataObject& gnDataObject, const GnUser& user, GnManagedPtr<IGnStatusEvents*> eventHandler) throw (GnError) :
	cancelled_(false)
{
...
{
	eventHandler_ = GnManagedPtr<IGnStatusEvents*>(pEventHandler, GnManagedPtr<IGnStatusEvents*>::ptr_nomanage);
	createWithElem(listElement, user);
}

GnLink::GnLink(const GnListElement& listElement, const GnUser& user, GnManagedPtr<IGnStatusEvents*> eventHandler) throw (GnError) :
	cancelled_(false)
{
	eventHandler_ = eventHandler;
	createWithElem(listElement, user);
...
void
GnLink::createWithObject(const metadata::GnDataObject& gnDataObject, const GnUser& user) throw (GnError)
{
...
void
GnLink::createWithElem(const GnListElement& listElement, const GnUser& user) throw (GnError)
{
	gnsdk_link_query_handle_t	query_handle = GNSDK_NULL;
	gnsdk_error_t				error;
 ...
 */
GnLinkContent
_GnImageArt(gnsdk_link_query_handle_t handle, GnImageSize imageSize, GnImagePreferenceType imagePreference, GnLinkContentType linkContentType, gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	...
	else if (imagePreference == kImagePreferenceSmallest)
	{
 ...
 */
GnLinkContent
GnLink::CoverArt(GnImageSize imageSize, GnImagePreferenceType imagePreference, gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	return _GnImageArt(native(), imageSize, imagePreference, kLinkContentCoverArt, itemOrdinal);
}
 ...
 */
GnLinkContent
GnLink::GenreArt(GnImageSize imageSize, GnImagePreferenceType imagePreference, gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	return _GnImageArt(native(), imageSize, imagePreference, kLinkContentGenreArt, itemOrdinal);
}
 ...
 */
GnLinkContent
GnLink::Image(GnImageSize imageSize, GnImagePreferenceType imagePreference, gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	return _GnImageArt(native(), imageSize, imagePreference, kLinkContentImage, itemOrdinal);
}
 ...
 */
GnLinkContent
GnLink::ArtistImage(GnImageSize imageSize, GnImagePreferenceType imagePreference, gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	return _GnImageArt(native(), imageSize, imagePreference, kLinkContentImageArtist, itemOrdinal);
}
...
GnLink::Review(gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	...
	error = gnsdk_link_query_content_retrieve(native(), gnsdk_link_content_review, itemOrdinal, &buffer_data_type, &buffer, &buffer_size);
	if (error) { throw GnError(); }
...
GnLink::Biography(gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	...
	error = gnsdk_link_query_content_retrieve(native(), gnsdk_link_content_biography, itemOrdinal, &buffer_data_type, &buffer, &buffer_size);
	if (error) { throw GnError(); }
...
GnLink::ArtistNews(gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	...
	error = gnsdk_link_query_content_retrieve(native(), gnsdk_link_content_artist_news, itemOrdinal, &buffer_data_type, &buffer, &buffer_size);
	if (error) { throw GnError(); }
...
GnLink::LyricXML(gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	...
	error = gnsdk_link_query_content_retrieve(native(), gnsdk_link_content_lyric_xml, itemOrdinal, &buffer_data_type, &buffer, &buffer_size);
	if (error) { throw GnError(); }
...
GnLink::LyricText(gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	...
	error = gnsdk_link_query_content_retrieve(native(), gnsdk_link_content_lyric_text, itemOrdinal, &buffer_data_type, &buffer, &buffer_size);
	if (error) { throw GnError(); }
...
GnLink::DspData(gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	...
	error = gnsdk_link_query_content_retrieve(native(), gnsdk_link_content_dsp_data, itemOrdinal, &buffer_data_type, &buffer, &buffer_size);
	if (error) { throw GnError(); }
...
GnLink::CommentsListener(gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	...
	error = gnsdk_link_query_content_retrieve(native(), gnsdk_link_content_comments_listener, itemOrdinal, &buffer_data_type, &buffer, &buffer_size);
	if (error) { throw GnError(); }
...
GnLink::CommentsRelease(gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	...
	error = gnsdk_link_query_content_retrieve(native(), gnsdk_link_content_comments_release, itemOrdinal, &buffer_data_type, &buffer, &buffer_size);
	if (error) { throw GnError(); }
...
GnLink::News(gnsdk_uint32_t itemOrdinal) throw (GnError)
{
	...
	error = gnsdk_link_query_content_retrieve(native(), gnsdk_link_content_news, itemOrdinal, &buffer_data_type, &buffer, &buffer_size);
	if (error) { throw GnError(); }
...
GnLink::Count(GnLinkContentType contentType) throw (GnError)
{
	...
	gnsdk_error_t error = gnsdk_link_query_content_count(native(), (gnsdk_link_content_type_t)contentType, &count);
	if (error) { throw GnError(); }
...
GnLinkContent::GnLinkContent(const gnsdk_byte_t* contentData, gnsdk_size_t dataSize, GnLinkContentType contentType, GnLinkDataType dataType) throw (GnError) :
	GnObject<const gnsdk_byte_t*>(contentData), mContentType((gnsdk_link_content_type_t)contentType), mDataType((gnsdk_link_data_type_t)dataType), mData(contentData), mDataSize(dataSize)
{ 
}
