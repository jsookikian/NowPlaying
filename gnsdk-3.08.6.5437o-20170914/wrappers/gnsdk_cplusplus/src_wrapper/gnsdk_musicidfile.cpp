...
GnMusicIdFileOptions::LookupMode(GnLookupMode lookupMode) throw (GnError)
{
	...
	error = gnsdk_musicidfile_query_option_set(weakhandle_, GNSDK_MUSICIDFILE_OPTION_LOOKUP_MODE, gnconvert::gn_lookup_mode_to_string(lookupMode));
...
GnMusicIdFileOptions::LookupData(GnLookupData lookupData, bool enable) throw (GnError)
{
	...
	case kLookupDataSortable:
		error = gnsdk_musicidfile_query_option_set(weakhandle_, GNSDK_MUSICIDFILE_OPTION_ENABLE_SORTABLE, sz_enable);
		break;
 ...
 */
void
GnMusicIdFileOptions::NetworkInterface(gnsdk_cstr_t intfName) throw (GnError)
{
	gnsdk_error_t error;
	
	error = gnsdk_musicidfile_query_option_set(weakhandle_, GNSDK_QUERY_OPTION_NETWORK_INTERFACE, intfName);
	if (error) { throw GnError(); }
}

gnsdk_cstr_t
GnMusicIdFileOptions::NetworkInterface() throw (GnError)
{
	gnsdk_cstr_t intfName = gnstd::kEmptyString;
	gnsdk_error_t error;
	
	error = gnsdk_musicidfile_query_option_get(weakhandle_, GNSDK_QUERY_OPTION_NETWORK_INTERFACE, &intfName);
	if (error) { throw GnError(); }
...
GnMusicIdFileOptions::PreferResultLanguage(GnLanguage preferredLangauge) throw (GnError)
{
	gnsdk_error_t error = gnsdk_musicidfile_query_option_set(weakhandle_,
															 ...
															 gnconvert::gn_language_to_string(preferredLangauge) );
...
GnMusicIdFileInfoManager::Remove(const GnMusicIdFileInfo& fileInfo) throw (GnError)
{
	...
	error = gnsdk_musicidfile_query_fileinfo_remove(weakhandle_, fileInfo.fileinfo_handle_);
	if (error) { throw GnError(); }
}
...
{
	eventHandler_ = GnManagedPtr<IGnMusicIdFileEvents*>(pEventHandler, GnManagedPtr<IGnMusicIdFileEvents*>::ptr_nomanage);
	create(user);
}

GnMusicIdFile::GnMusicIdFile(const GnUser& user, GnManagedPtr<IGnMusicIdFileEvents*> eventHandler) throw (GnError)
{
...
void
GnMusicIdFile::create(const GnUser& user) throw (GnError)
{
...
GnMusicIdFile::DoTrackId(GnMusicIdFileProcessType processType, GnMusicIdFileResponseType responseType) throw (GnError)
{
	...
	error = gnsdk_musicidfile_query_do_trackid(native(), queryflags);
...
GnMusicIdFile::DoAlbumId(GnMusicIdFileProcessType processType, GnMusicIdFileResponseType responseType) throw (GnError)
{
	...
	error = gnsdk_musicidfile_query_do_albumid(native(), queryflags);
	if (GNSDKERR_SEVERE(error))	{throw GnError();}
...
GnMusicIdFile::DoLibraryId(GnMusicIdFileResponseType responseType) throw (GnError)
{
	...
	error = gnsdk_musicidfile_query_do_libraryid(native(), queryFlags);
	if (GNSDKERR_SEVERE(error)) { throw GnError(); }
}
...
GnMusicIdFile::WaitForComplete(gnsdk_uint32_t timeoutValue) throw (GnError)
{
	...
	error = gnsdk_musicidfile_query_wait_for_complete(native(), timeoutValue, &pMidFComplteError);
...
GnMusicIdFile::WaitForComplete() throw (GnError)
{
	...
	error = gnsdk_musicidfile_query_wait_for_complete(native(), GnMusicIdFile::kTimeValueInfinite, &pMidFComplteError);
	if (GNSDKERR_SEVERE(error) || GNSDKERR_SEVERE(pMidFComplteError)) { throw GnError(); }
}
...
GnMusicIdFile::Cancel()
{
	...
	error = gnsdk_musicidfile_query_cancel(native());
	if (GNSDKERR_SEVERE(error)) { throw GnError(); }
...
GnMusicIdFileInfo::Identifier() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_IDENT, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::FileName() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_FILENAME, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::FileName(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_FILENAME, value);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::CddbId() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_CDDB_IDS, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::CddbId(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_CDDB_IDS, value);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::AlbumArtist() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_ALBUMARTIST, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::AlbumArtist(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_ALBUMARTIST, value);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::AlbumTitle() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_ALBUMTITLE, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::AlbumTitle(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_ALBUMTITLE, value);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::TrackArtist() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TRACKARTIST, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::TrackArtist(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TRACKARTIST, value);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::TrackTitle() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TRACKTITLE, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::TrackTitle(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TRACKTITLE, value);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::TrackNumber() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TRACKNUMBER, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::TrackNumber(gnsdk_uint32_t trackNumber) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TRACKNUMBER, buf);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::DiscNumber() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_DISCNUMBER, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::DiscNumber(gnsdk_uint32_t discNumber) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_DISCNUMBER, buf);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::TagId() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TAGID, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::TagId(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TAGID, value);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::Fingerprint() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_FINGERPRINT, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::Fingerprint(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_FINGERPRINT, value);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::MediaId() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_MEDIA_ID, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::MediaId(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_MEDIA_ID, value);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::Mui() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_MUI, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::Mui(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_MUI, value);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::CdToc() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TOC_OFFSETS, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::CdToc(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TOC_OFFSETS, value);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::Tui() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TUI, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::Tui(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TUI, value);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::TuiTag() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_get(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TUI_TAG, &sz_value, GNSDK_NULL);
	if (GNSDKERR_SEVERE(error) ) { throw GnError(); }
...
GnMusicIdFileInfo::TuiTag(gnsdk_cstr_t value) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_metadata_set(fileinfo_handle_, GNSDK_MUSICIDFILE_FILEINFO_VALUE_TUI_TAG, value);
	if (error) { throw GnError(); }
}
...
throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_fingerprint_begin(fileinfo_handle_, audioSampleRate, audioSampleSize, audioChannels);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::FingerprintWrite(const gnsdk_byte_t* audioData, gnsdk_size_t audioDataSize) throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_fingerprint_write(fileinfo_handle_, audioData, audioDataSize, &b_complete);
	if (error) { throw GnError(); }
...
GnMusicIdFileInfo::FingerprintEnd() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_fingerprint_end(fileinfo_handle_);
	if (error) { throw GnError(); }
}
...
GnMusicIdFileInfo::FingerprintFromSource(IGnAudioSource& audioSource)  throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_fingerprint_begin(fileinfo_handle_, audioSource.SamplesPerSecond(), audioSource.SampleSizeInBits(), audioSource.NumberOfChannels() );
	if (!error)
	{
		...
		if ( audioSizeInBytes != 0 )
		{
			...
			if (!error)
			{
				...
				{
					error = gnsdk_musicidfile_fileinfo_fingerprint_write(fileinfo_handle_, pAudioBuffer, audioDataSize, &bComplete);
					if (error)
					{
						break;
					}
...
GnMusicIdFileInfo::Status() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_status(fileinfo_handle_, &status, &pErrorInfo);
	if (error) { throw GnError(); }
...
GnMusicIdFileInfo::AlbumResponse() throw (GnError)
{
	...
	error = gnsdk_musicidfile_fileinfo_get_response_gdo(fileinfo_handle_, &response_gdo);
	if (error) { throw GnError(); }
