...
/*	Define one of these display languages...
#define LOCALE_LANGUAGE		GNSDK_LANG_ENGLISH
#define LOCALE_LANGUAGE		GNSDK_LANG_CHINESE_SIMP
#define LOCALE_LANGUAGE		GNSDK_LANG_CHINESE_TRAD
*/
...
_do_sample_album_searches( gnsdk_user_handle_t user_handle )
{
	...
	_do_sample_album_search(user_handle, GNSDK_NULL, GNSDK_NULL, "五月天 & 孫燕姿");
